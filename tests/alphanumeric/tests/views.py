...
class ViewsTestCase(TestCaseWithFixture):
    def test_gets(self):
        ...
        self.assertEqual(
            [obj["name"] for obj in deserialized["objects"]],
            [
                u"Skateboardrampe",
                u"Bigwheel",
                u"Trampolin",
        ...
        resp = self.client.get(
            "/api/v1/products/set/11111;76123/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 1)
        ...
        resp = self.client.get(
            "/api/v1/products/set/WS65150-01;65100A-01/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 1)
        self.assertEqual(len(deserialized["objects"]), 2)
        self.assertEqual(
            [obj["name"] for obj in deserialized["objects"]], [u"Trampolin", u"Laufrad"]
        )
        ...
        resp = self.client.get(
            "/api/v1/products/set/76123/01;65100A-01/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 1)
        self.assertEqual(len(deserialized["objects"]), 2)
        self.assertEqual(
            [obj["name"] for obj in deserialized["objects"]], [u"Bigwheel", u"Laufrad"]
        )

        resp = self.client.get(
            "/api/v1/products/WS65150/01-01/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 5)
        ...
        resp = self.client.get(
            "/api/v1/products/set/76123/01;WS65150/01-01/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 1)
        ...
        self.assertEqual(
            [obj["name"] for obj in deserialized["objects"]],
            [u"Bigwheel", u"Human Hamsterball"],
        )
        ...
        resp = self.client.get(
            "/api/v1/products/set/76123/01;WS77.86/", data={"format": "json"}
        )
        self.assertEqual(resp.status_code, 200)
        deserialized = json.loads(resp.content.decode("utf-8"))
        self.assertEqual(len(deserialized), 1)
        self.assertEqual(len(deserialized["objects"]), 2)
        self.assertEqual(
            [obj["name"] for obj in deserialized["objects"]], [u"Bigwheel", u"Ant Farm"]
        )
    ...
    def test_posts(self):
        ...
        resp = self.client.post(
            "/api/v1/products/", data=post_data, content_type="application/json"
        )
...
class MoreViewsTestCase(TestCaseWithFixture):
    def test_get_apis_json(self):
        ...
        self.assertEqual(
            data,
            '{"products": {"list_endpoint": "/api/v1/products/", "schema": "/api/v1/products/schema/"}}',
        )
    ...
    def test_post_object(self):
        ...
        response = self.client.get(
            "/api/v1/products/A76124/03/", HTTP_ACCEPT="application/json"
        )
