...
class TagResource(ModelResource):
    taggabletags = fields.ToManyField(
        "related_resource.api.resources.TaggableTagResource", "taggabletags", null=True
    )
...
class TaggableTagResource(ModelResource):
    tag = fields.ToOneField(
        "related_resource.api.resources.TagResource", "tag", null=True
    )
    taggable = fields.ToOneField(
        "related_resource.api.resources.TaggableResource", "taggable", null=True
    )
...
class CompanyResource(ModelResource):
    ...
    products = fields.ToManyField(
        ProductResource, "products", full=True, related_name="producer", null=True
    )
...
class PersonResource(ModelResource):
    ...
    dogs = fields.ToManyField(
        "related_resource.api.resources.DogResource",
        "dogs",
        full=True,
        related_name="owner",
        null=True,
...
class BoneResource(ModelResource):
    dog = fields.ToOneField(
        "related_resource.api.resources.DogResource", "dog", null=True
    )
...
class DogResource(ModelResource):
    ...
    bones = fields.ToManyField(
        BoneResource, "bones", full=True, null=True, related_name="dog"
    )
...
class ContactResource(ModelResource):
    groups = fields.ToManyField(
        ContactGroupResource, "groups", related_name="members", null=True, blank=True
    )
