...
class SerializerTestCase(TestCase):
    def test_init(self):
        ...
        self.assertEqual(
            serializer_1.supported_formats,
            ["application/json", "application/xml", "text/yaml", "application/x-plist"],
        )
        ...
        serializer_3 = Serializer(
            formats=["json", "xml"],
            content_types={"json": "text/json", "xml": "application/xml"},
        )
        self.assertEqual(serializer_3.formats, ["json", "xml"])
        self.assertEqual(
            serializer_3.content_types, {"xml": "application/xml", "json": "text/json"}
        )
        self.assertEqual(
        ...
        serializer_4 = Serializer(
            formats=["plist", "json"],
            content_types={"plist": "application/x-plist", "json": "application/json"},
        )
        self.assertEqual(serializer_4.formats, ["plist", "json"])
        self.assertEqual(
            serializer_4.content_types,
            {"plist": "application/x-plist", "json": "application/json"},
        )
        self.assertEqual(
            serializer_4.supported_formats, ["application/x-plist", "application/json"]
        )
    ...
    def test__to_simple__string(self):
        ...
        self.assertEqual(
            serializer.to_simple(val, None),
            u"áhhh! I'm letting all the á's out of my body.",
        )

    def test__to_simple__datetime(self):
        serializer = Serializer()
        self.assertEqual(
            serializer.to_simple(datetime.datetime(2010, 12, 16, 2, 31, 33), None),
            "2010-12-16T02:31:33",
        )
    ...
    def test__to_simple__date(self):
        serializer = Serializer()
        self.assertEqual(
            serializer.to_simple(datetime.date(2010, 12, 16), None), "2010-12-16"
        )

    def test__to_simple__time(self):
        serializer = Serializer()
        self.assertEqual(
            serializer.to_simple(datetime.time(2, 31, 33), None), "02:31:33"
        )

    def test_format_datetime(self):
        serializer = Serializer()
        self.assertEqual(
            serializer.format_datetime(datetime.datetime(2010, 12, 16, 2, 31, 33)),
            "2010-12-16T02:31:33",
        )
        ...
        self.assertEqual(
            serializer.format_datetime(datetime.datetime(2010, 12, 16, 2, 31, 33, 10)),
            "2010-12-16T02:31:33",
        )
    ...
    def test_format_date(self):
        serializer = Serializer()
        self.assertEqual(
            serializer.format_date(datetime.date(2010, 12, 16)), "2010-12-16"
        )
        ...
        serializer = Serializer(datetime_formatting="rfc-2822")
        self.assertEqual(
            serializer.format_date(datetime.date(2010, 12, 16)), u"16 Dec 2010"
        )
    ...
    def test_format_time(self):
        ...
        serializer = Serializer(datetime_formatting="iso-8601-strict")
        self.assertEqual(
            serializer.format_time(datetime.time(2, 31, 33, 10)), "02:31:33"
        )

        serializer = Serializer(datetime_formatting="rfc-2822")
        self.assertEqual(
            serializer.format_time(datetime.time(2, 31, 33)), u"02:31:33 -0600"
        )
        ...
        with self.settings(TASTYPIE_DATETIME_FORMATTING="iso-8601"):
            serializer = Serializer()
            self.assertEqual(
                serializer.format_time(datetime.time(2, 31, 33)), "02:31:33"
            )
    ...
    def test_unsafe_yaml(self):
        ...
        self.assertRaises(
            yaml.constructor.ConstructorError, serializer.from_yaml, serialized
        )
    ...
    def test_invalid_jsonp_characters(self):
        ...
        jsonp = serializer.to_jsonp(
            {"foo": u"Hello \u2028\u2029world!"}, {"callback": "callback"}
        )
...
class ResourceSerializationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.another_obj_list = [
            self.another_resource.full_dehydrate(self.resource.build_bundle(obj=obj))
