...
class MimeTestCase(TestCase):
    def test_build_content_type(self):
        ...
        self.assertEqual(
            build_content_type("application/json", encoding="ascii"), "application/json"
        )
        # Everything else should.
        self.assertEqual(
            build_content_type("application/xml"), "application/xml; charset=utf-8"
        )
        self.assertEqual(
            build_content_type("application/xml", encoding="ascii"),
