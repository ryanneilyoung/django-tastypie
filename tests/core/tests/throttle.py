...
class NoThrottleTestCase(TestCase):
    ...
    def test_convert_identifier_to_key(self):
        ...
        self.assertEqual(
            throttle_1.convert_identifier_to_key("alnum10"), "alnum10_accesses"
        )
        self.assertEqual(
            throttle_1.convert_identifier_to_key("Mr. Pants"), "Mr.Pants_accesses"
        )
        self.assertEqual(
            throttle_1.convert_identifier_to_key("Mr_Pants"), "Mr_Pants_accesses"
        )
