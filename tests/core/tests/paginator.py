...
class PaginatorTestCase(TestCase):
    ...
    def test_page1(self):
        ...
        paginator = Paginator(
            {}, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=0
        )
    ...
    def test_page2(self):
        paginator = Paginator(
            {}, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=2
        )
        meta = paginator.page()["meta"]
        self.assertEqual(meta["limit"], 2)
    ...
    def test_page3(self):
        paginator = Paginator(
            {}, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=4
        )
        meta = paginator.page()["meta"]
        self.assertEqual(meta["limit"], 2)
    ...
    def test_page2_with_request(self):
        for req in [{"offset": "2", "limit": "2"}, QueryDict("offset=2&limit=2")]:
            paginator = Paginator(
                req, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=2
            )
            meta = paginator.page()["meta"]
            self.assertEqual(meta["limit"], 2)
            self.assertEqual(meta["offset"], 2)
    ...
    def test_page3_with_request(self):
        for req in [{"offset": "4", "limit": "2"}, QueryDict("offset=4&limit=2")]:
            paginator = Paginator(
                req, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=4
            )
            meta = paginator.page()["meta"]
            self.assertEqual(meta["limit"], 2)
            self.assertEqual(meta["offset"], 4)
    ...
    def test_large_limit(self):
        paginator = Paginator(
            {}, self.data_set, resource_uri="/api/v1/notes/", limit=20, offset=0
        )
        meta = paginator.page()["meta"]
    ...
    def test_complex_get(self):
        ...
        paginator = Paginator(
            request, self.data_set, resource_uri="/api/v1/notes/", limit=2, offset=2
        )
        meta = paginator.page()["meta"]
        self.assertEqual(meta["limit"], 2)
        self.assertEqual(meta["offset"], 2)
    ...
    def test_offset(self):
        ...
        self.assertTrue(raised)
        self.assertEqual(
            str(raised), "Invalid offset 'hAI!' provided. Please provide an integer."
        )
    ...
    def test_max_limit(self):
        paginator = Paginator(
            {"limit": 0}, self.data_set, max_limit=10, resource_uri="/api/v1/notes/"
        )
        meta = paginator.page()["meta"]
    ...
    def test_max_limit_none(self):
        paginator = Paginator(
            {"limit": 0}, self.data_set, max_limit=None, resource_uri="/api/v1/notes/"
        )
        meta = paginator.page()["meta"]
