...
class ApiFieldTestCase(TestCase):
    ...
    def test_dehydrate(self):
        ...
        note.author = None
        note.save()
        field_8 = ApiField(attribute="author", null=True, default=original_author)
...
class FileFieldTestCase(TestCase):
    ...
    def test_dehydrate(self):
        ...
        self.assertEqual(
            field_1.dehydrate(bundle), u"http://localhost:8080/media/lulz/catz.gif"
        )

        field_2 = FileField(default="http://media.example.com/img/default_avatar.jpg")
        self.assertEqual(
            field_2.dehydrate(bundle),
...
class DictFieldTestCase(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            field_1.help_text,
            "A dictionary of data. Ex: {'price': 26.73, 'name': 'Daniel'}",
        )
...
class DateTimeFieldTestCase(TestCase):
    ...
    def test_dehydrate(self):
        ...
        self.assertEqual(
            field_3.dehydrate(bundle), aware_datetime(2010, 4, 2, 1, 11, 1)
        )

        note.created_string = "2010-04-02 01:11:02"
        self.assertEqual(
            field_3.dehydrate(bundle), aware_datetime(2010, 4, 2, 1, 11, 2)
        )
    ...
    def test_hydrate(self):
        ...
        self.assertEqual(
            field_1.hydrate(bundle_1), aware_datetime(2010, 5, 12, 10, 36, 28)
        )
        ...
        self.assertEqual(
            ...
            aware_datetime(2010, 3, 30, 20, 5, tzinfo=tzoffset(None, -18000)),
        )
...
class ToOneFieldTestCase(TestCase):
    ...
    def test_init(self):
        ...
        field_2 = ToOneField(
            UserResource, "author", null=True, help_text="Points to a User."
        )
        self.assertEqual(field_2.instance_name, None)
        ...
        field_3 = ToOneField(
            UserResource, "author", default=1, null=True, help_text="Points to a User."
        )
    ...
    def test_resource_from_uri(self):
        ...
        fk_bundle = field_1.resource_from_uri(
            ur, "/api/v1/users/1/", related_obj="Foo", related_name="Bar"
        )
    ...
    def test_resource_from_data(self):
        ur = UserResource()
        field_1 = ToOneField(UserResource, "author")
        fk_bundle = field_1.resource_from_data(
            ur,
            {
                "username": u"mistersmith",
                "email": u"smith@example.com",
    ...
    def test_resource_from_pk(self):
        ...
        fk_bundle = field_1.resource_from_pk(
            ur, user, related_obj="Foo", related_name="Bar"
        )
        self.assertEqual(fk_bundle.related_obj, None)
        self.assertEqual(fk_bundle.related_name, None)
...
class ToManyFieldTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.subject_3 = Subject.objects.create(
            name="Personal Interest", url="/news/personal-interest/"
        )
    ...
    def test_init(self):
        ...
        field_2 = ToManyField(
            SubjectResource, "subjects", null=True, help_text="Points to many Subjects."
        )
        self.assertEqual(field_2.instance_name, None)
        ...
        field_3 = ToManyField(
            ...
            default=1,
            null=True,
            help_text="Points to many Subjects.",
        )
        self.assertEqual(field_3.instance_name, None)
    ...
    def test_dehydrate(self):
        ...
        self.assertEqual(
            field_3.dehydrate(bundle_3), ["/api/v1/subjects/1/", "/api/v1/subjects/2/"]
        )
        ...
        self.assertEqual(
            field_5.dehydrate(bundle_5), ["/api/v1/subjects/1/", "/api/v1/subjects/3/"]
        )
    ...
    def test_dehydrate_full_detail_list(self):
        ...
        self.assertEqual(
            field_1.dehydrate(bundle_1, for_list=False),
        ...
        field_5 = ToManyField(
            SubjectResource, "subjects", full=True, full_list=lambda x: True
        )
        field_5.instance_name = "m2m"
        request = MockRequest()
        request.path = "/api/v1/subjects/"
        ...
        field_6 = ToManyField(
            SubjectResource, "subjects", full=True, full_list=lambda x: False
        )
        field_6.instance_name = "m2m"
        request = MockRequest()
        request.path = "/api/v1/subjects/"
        ...
        self.assertEqual(
            field_6.dehydrate(bundle_6), ["/api/v1/subjects/1/", "/api/v1/subjects/2/"]
        )

        # detail url with callable returning True
        field_7 = ToManyField(
            SubjectResource, "subjects", full=True, full_detail=lambda x: True
        )
        field_7.instance_name = "m2m"
        request = MockRequest()
        request.path = "/api/v1/subjects/%(pk)s/" % {"pk": self.note_1.pk}
        ...
        field_8 = ToManyField(
            SubjectResource, "subjects", full=True, full_detail=lambda x: False
        )
        ...
        self.assertEqual(
            field_8.dehydrate(bundle_8, for_list=False),
            ["/api/v1/subjects/1/", "/api/v1/subjects/2/"],
        )
    ...
    def test_dehydrate_with_callable(self):
        ...
        field_1 = ToManyField(
            SubjectResource,
            attribute=lambda bundle: Subject.objects.filter(
                notes=bundle.obj, name__startswith="Personal"
            ),
        )
        field_1.instance_name = "m2m"
    ...
    def test_traversed_attribute_dehydrate(self):
        ...
        field_1.instance_name = "m2m"
        self.assertEqual(
            field_1.dehydrate(bundle), ["/api/v1/subjects/1/", "/api/v1/subjects/2/"]
        )
