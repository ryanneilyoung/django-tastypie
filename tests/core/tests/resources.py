...
from core.models import (
    ...
    MyRelatedUUIDModel,
    BigAutoNowModel,
    MyContainerItemModel,
    MyContainerItemGroupingModel,
    MyContainerModel,
)
...
class BasicResourceWithDifferentListAndDetailFieldsCallable(Resource):
    ...
    view_count = fields.IntegerField(
        attribute="view_count", default=0, use_in=lambda x: True
    )
...
class ResourceTestCase(TestCase):
    ...
    def test_fields(self):
        ...
        self.assertEqual(
            isinstance(basic.fields["view_count"], fields.IntegerField), True
        )
        ...
        self.assertEqual(
            isinstance(basic.fields["date_joined"], fields.DateTimeField), True
        )
        ...
        self.assertEqual(
            isinstance(basic.fields["resource_uri"], fields.CharField), True
        )
    ...
    def test_full_hydrate(self):
        ...
        self.assertEqual(
            hydrated.data["date_joined"], aware_datetime(2010, 2, 15, 12, 0, 0)
        )
        self.assertEqual(hydrated.obj.name, "Daniel")
        self.assertEqual(hydrated.obj.view_count, 6)
        self.assertEqual(
            hydrated.obj.date_joined, aware_datetime(2010, 2, 15, 12, 0, 0)
        )

        another = AnotherBasicResource()
        another_bundle_1 = Bundle(
            data={
                "name": "Daniel",
                "view_count": 6,
                "date_joined": aware_datetime(2010, 2, 15, 12, 0, 0),
    ...
    def test_build_schema__altered_meta(self):
        ...
        schema = adjust_schema(basic.build_schema())
        expected_schema = {
            "filtering": {"name": 1, "date_joined": ["gt", "gte"]},
            "allowed_detail_http_methods": ["get", "post", "put", "delete", "patch"],
    ...
    def test_method_check(self):
        ...
        self.assertRaises(
            ImmediateHttpResponse, basic.method_check, request, allowed=["post"]
        )
        ...
        # Not an allowed request.
        self.assertRaises(
            ImmediateHttpResponse, basic.method_check, request, allowed=["get"]
        )
    ...
    def test_get_list_with_use_in(self):
        ...
        basic_resource_list = json.loads(force_str(basic.get_list(request).content))[
            "objects"
        ]
...
if MyUUIDModel:
    ...
    class MyRelatedUUIDModelResource(ModelResource):
        myuuidmodels = fields.ManyToManyField(
            MyUUIDModelResourceNonUniqueDetailUriName, "myuuidmodels", full=True
        )
...
class AlwaysUserNoteResource(NoteResource):
    ...
    def get_object_list(self, request):
        return (
            super(AlwaysUserNoteResource, self)
...
class DetailedNoteResourceWithHydrate(DetailedNoteResource):
    def hydrate(self, bundle):
        bundle.data[
            ...
            bundle.request.user
        )  # This should fail using TastyPie 0.9.11 if triggered in patch_list
        return bundle
...
class FunctionAttributeFKNoteResource(ModelResource):
    editor = fields.ForeignKey(
        UserResource, lambda bundle: User.objects.first(), null=True
    )
...
class PerUserNoteResource(NoteResource):
    ...
    def authorized_read_list(self, object_list, bundle):
        ...
        new_object_list = super(PerUserNoteResource, self).authorized_read_list(
            object_list, bundle
        )
...
class PerObjectNoteResource(NoteResource):
    ...
    def authorized_read_list(self, object_list, bundle):
        ...
        new_object_list = super(PerObjectNoteResource, self).authorized_read_list(
            object_list, bundle
        )
...
class CounterAuthorization(Authorization):
    def create_detail(self, object_list, bundle, *args, **kwargs):
        bundle._create_auth_call_count = (
            getattr(bundle, "_create_auth_call_count", 0) + 1
        )
        return True

    def update_detail(self, object_list, bundle, *args, **kwargs):
        bundle._update_auth_call_count = (
            getattr(bundle, "_update_auth_call_count", 0) + 1
        )
        return True
...
class MyContainerItemModelResource(ModelResource):
    parent = fields.ForeignKey(
        "core.tests.resources.MyContainerModelResource", "parent"
    )
...
class MyContainerModelResource(ModelResource):
    container_items = fields.ToManyField(
        MyContainerItemModelResource, "item_set", blank=True
    )
    container_grouping_items = fields.ToManyField(
        MyContainerItemGroupingModel, "item_grouping_set", blank=True
    )
...
class ModelResourceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.subject_1 = Subject.objects.create(name="News", url="/news/")
        self.subject_2 = Subject.objects.create(name="Photos", url="/photos/")
    ...
    def test_exception_handling(self, obj_get_list_mock, send_signal_mock):
        ...
        self.assertTrue(
            obj_get_list_mock.called,
            msg="Test invalid: obj_get_list should have been dispatched",
        )
        self.assertTrue(
            send_signal_mock.called,
            msg="got_request_exception was not called after an error",
        )
    ...
    def test_init(self):
        ...
        self.assertEqual(
            resource_1._meta.list_allowed_methods,
            ["get", "post", "put", "delete", "patch"],
        )
        self.assertEqual(
            resource_1._meta.detail_allowed_methods,
            ["get", "post", "put", "delete", "patch"],
        )
        ...
        self.assertEqual(
            resource_3._meta.detail_allowed_methods, ["get", "post", "put"]
        )
        self.assertEqual(
            isinstance(resource_3._meta.serializer, CustomSerializer), True
        )
    ...
    def test_fields(self):
        ...
        self.assertTrue(
            isinstance(annr.fields["created"]._default(), datetime.datetime)
        )
        ...
        self.assertTrue(
            isinstance(annr.fields["updated"]._default(), datetime.datetime)
        )
    ...
    def test_abstract_model_resource(self):
        ...
        for attr in (
            ...
            self.assertFalse(
                getattr(AbstractNoteResource, attr, False),
    ...
    def test_urls(self):
        ...
        self.assertEqual(
            reverse(
                "api_dispatch_list",
                urlconf="core.tests.manual_urls",
                kwargs={
                    "resource_name": "notes",
                },
            ),
    ...
    def test_determine_format(self):
        ...
        request.META = {
            "HTTP_ACCEPT": "text/plain,application/xml,application/json;q=0.9,*/*;q=0.8"
        }
        self.assertEqual(resource.determine_format(request), "application/xml")
    ...
    def test_build_filters(self):
        ...
        self.assertEqual(
            resource.build_filters(filters={"resource_url__exact": "/foo/bar/"}), {}
        )

        # Filter valid but disallowed.
        self.assertRaises(
            InvalidFilterError,
            resource.build_filters,
            filters={"slug__startswith": "whee"},
        )
        ...
        self.assertEqual(
            resource.build_filters(filters={"title": "Hello world."}),
            {"title__exact": "Hello world."},
        )

        # Valid simple (explicit ``__exact``).
        self.assertEqual(
            resource.build_filters(filters={"title__exact": "Hello world."}),
            {"title__exact": "Hello world."},
        )

        # Valid in (using ``,``).
        self.assertEqual(
            resource.build_filters(filters={"title__in": ""}), {"title__in": ""}
        )
        self.assertEqual(
            resource.build_filters(filters={"title__in": "foo"}), {"title__in": ["foo"]}
        )
        self.assertEqual(
            resource.build_filters(filters={"title__in": "foo,bar"}),
            {"title__in": ["foo", "bar"]},
        )

        # Valid in (using multiple params).
        self.assertEqual(
            resource.build_filters(filters=QueryDict("title__in=foo&title__in=bar")),
            {"title__in": ["foo", "bar"]},
        )
        self.assertEqual(
            resource.build_filters(filters=QueryDict("title__in=foo,bar")),
            {"title__in": ["foo", "bar"]},
        )

        # Valid simple (non-``__exact``).
        self.assertEqual(
            resource.build_filters(filters={"content__startswith": "Hello"}),
            {"content__startswith": "Hello"},
        )

        # Valid boolean.
        self.assertEqual(
            resource.build_filters(filters={"title": "true"}), {"title__exact": True}
        )
        self.assertEqual(
            resource.build_filters(filters={"title": "True"}), {"title__exact": True}
        )
        ...
        self.assertEqual(
            resource.build_filters(filters={"title": "false"}), {"title__exact": False}
        )
        self.assertEqual(
            resource.build_filters(filters={"title": "False"}), {"title__exact": False}
        )
        ...
        self.assertEqual(
            resource.build_filters(filters={"title": "nil"}), {"title__exact": None}
        )
        self.assertEqual(
            resource.build_filters(filters={"title": "none"}), {"title__exact": None}
        )
        self.assertEqual(
            resource.build_filters(filters={"title": "None"}), {"title__exact": None}
        )
        ...
        self.assertEqual(
            resource_2.build_filters(filters=filters_1),
            {
                "title__exact": "RAGE",
                "slug__exact": "Hello",
                "author__gt": 2,
        ...
        self.assertRaises(
            InvalidFilterError,
            resource_3.build_filters,
            filters={"author__username__startswith": "j"},
        )

        # Allow relationship traversal.
        self.assertEqual(
            resource_3.build_filters(filters={"subjects__name__startswith": "News"}),
            {"subjects__name__startswith": "News"},
        )
        ...
        self.assertRaises(
            InvalidFilterError,
            resource_3.build_filters,
            filters={"subjects__url__startswith": "News"},
        )
        ...
        self.assertRaises(
            InvalidFilterError,
            resource_3.build_filters,
            filters={"subjects__foo__startswith": "News"},
        )

        # Check where the field name doesn't match the database relation.
        resource_4 = AnotherSubjectResource()
        self.assertEqual(
            resource_4.build_filters(filters={"notes__user__startswith": "Daniel"}),
            {"notes__author__startswith": "Daniel"},
        )
    ...
    def test_custom_build_filters(self):
        ...
        class MyResource(NoteResource):
            def build_filters(self, filters=None, **kwargs):
                ...
                if "title" in filters:
                    orm_filters["pk__in"] = Note.objects.filter(
                        title=filters["title"]
    ...
    def test_xss_regressions(self):
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"error": "Lookups are not allowed more than one level deep on the \'author\' field."}',
        )
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"error": "Invalid limit \'&lt;img%20src=\\"http://ycombinator.com/images/y18.gif\\"&gt;\' provided. Please provide a positive integer."}',
        )
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"error": "Invalid offset \'&lt;script&gt;alert(\\"XSS\\")&lt;/script&gt;\' provided. Please provide an integer."}',
        )
    ...
    def test_apply_sorting(self):
        ...
        self.assertRaises(
            InvalidSortError,
            resource.apply_sorting,
            object_list,
            options={"order_by": "foobar"},
        )
        ...
        self.assertRaises(
            ...
            resource.apply_sorting,
            object_list,
            options={"order_by": "resource_uri"},
        )

        # Valid ascending.
        object_list = resource.obj_get_list(base_bundle)
        ordered_list = resource.apply_sorting(
            object_list, options={"order_by": "title"}
        )
        ...
        object_list = resource.obj_get_list(base_bundle)
        ordered_list = resource.apply_sorting(
            object_list, options={"order_by": "-slug"}
        )
        self.assertEqual([obj.id for obj in ordered_list], [4, 6, 1, 2])
        ...
        object_list = resource.obj_get_list(base_bundle)
        ordered_list = resource.apply_sorting(
            object_list, options={"sort_by": "-title"}
        )
        self.assertEqual([obj.id for obj in ordered_list], [4, 6, 1, 2])
        ...
        object_list = resource.obj_get_list(base_bundle)
        ordered_list = resource.apply_sorting(
            object_list, options={"order_by": ["title", "-slug"]}
        )
        self.assertEqual([obj.id for obj in ordered_list], [2, 1, 6, 4])
        ...
        ordered_list = resource_2.apply_sorting(
            object_list, options={"order_by": "-user"}
        )
        ...
        object_list = resource_2.obj_get_list(base_bundle)
        ordered_list = resource_2.apply_sorting(
            object_list, options={"order_by": "-user__baz"}
        )
        ...
        object_list = resource_2.obj_get_list(base_bundle)
        ordered_list = resource_2.apply_sorting(
            object_list, options={"order_by": "user__id"}
        )
        self.assertEqual([obj.id for obj in ordered_list], [1, 2, 4, 6])
        ...
        object_list = resource_2.obj_get_list(base_bundle)
        ordered_list = resource_2.apply_sorting(
            object_list, options={"order_by": ["-user__username", "title"]}
        )
        self.assertEqual([obj.id for obj in ordered_list], [2, 1, 6, 4])
    ...
    def test_get_list(self):
        ...
        self.assertTrue(
            "monkey" in res["error"]
        )  # Error looks like "No matching \'monkey\' field for ordering on.
    ...
    def test_get_detail(self):
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"content": "This is my very first post using my shiny new API. Pretty sweet, huh?", "created": "2010-03-30T20:05:00", "id": 1, "is_active": true, "resource_uri": "/api/v1/notes/1/", "slug": "first-post", "title": "First Post!", "updated": "2010-03-30T20:05:00"}',
        )
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"content": "The dog ate my cat today. He looks seriously uncomfortable.", "created": "2010-03-31T20:05:00", "id": 2, "is_active": true, "resource_uri": "/api/v1/notes/2/", "slug": "another-post", "title": "Another Post", "updated": "2010-03-31T20:05:00"}',
        )
    ...
    def test_put_list(self):
        ...
        request.set_body(
            '{"objects": [{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back-again", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}]}'
        )
    ...
    def test_put_detail(self):
        ...
        request.method = "PUT"
        request.set_body(
            '{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00", "baddata": "some data"}'
        )
        ...
        request.set_body(
            '{"content": "The cat is gone again. I think it was the rabbits that ate him this time.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back", "title": "The Cat Is Gone", "updated": "2010-04-03 20:05:00"}'
        )
        ...
        self.assertEqual(
            new_note.content,
            u"The cat is gone again. I think it was the rabbits that ate him this time.",
        )
        ...
        self.assertEqual(
            data["content"],
            "The cat is gone again. I think it was the rabbits that ate him this time.",
        )
        ...
        request.method = "PUT"
        request.set_body(
            '{"content": "The cat is back. The dog coughed him up out back.", "created": "2016-12-12 14:10:00", "is_active": true, "slug": "cat-is-back-again", "title": "The Cat Is Back", "updated": "2016-12-12 14:10:00"}'
        )
    ...
    def test_put_detail_with_use_in(self):
        ...
        request.method = "PUT"
        request.set_body(
            '{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}'
        )
    ...
    def test_put_detail_with_identifiers(self):
        ...
        request.method = "PUT"
        request.set_body(
            '{"date": "2012-09-07", "username": "WAT", "message": "hello"}'
        )
        ...
        request.method = "PUT"
        request.set_body(
            '{"date": "2012-09-07", "username": "maraujop", "message": "WAT"}'
        )
        date_record_resource = DateRecordResource()
    ...
    def test_put_detail_with_non_unique_detail_uri_name(self):
        ...
        request.method = "PUT"
        request.set_body(
            '{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}'
        )
    ...
    def test_patch_detail_with_m2m_non_unique_uuid_detail_uri_name(self):
        ...
        data = {
            "myuuidmodels": [
                {
                    "content": "foo",
                    "resource_uri": MyUUIDModelResourceNonUniqueDetailUriName().get_resource_uri(
                        myuuidmodel
                    ),
                },
                {
        ...
        self.assertEqual(
            resp_data["myuuidmodels"][0]["anotheruuid"], str(myuuidmodel.anotheruuid)
        )
        self.assertEqual(
            resp_data["myuuidmodels"][0]["content"], data["myuuidmodels"][0]["content"]
        )
        self.assertEqual(
            resp_data["myuuidmodels"][1]["content"], data["myuuidmodels"][1]["content"]
        )
    ...
    def test_patch_list(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"objects": [{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back-again", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}, {"resource_uri": "/api/v1/notes/2/", "content": "This is note 2."}], "deleted_objects": ["/api/v1/notes/1/"]}'
    ...
    def test_patch_list_return_data(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"objects": [{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-is-back-again", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}, {"resource_uri": "/api/v1/alwaysdatanote/2/", "content": "This is note 2."}], "deleted_objects": ["/api/v1/alwaysdatanote/1/"]}'
    ...
    def test_patch_list_bad_resource_uri(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"objects": [{"resource_uri": "/api/v1/notes/99999/", "content": "This is an invalid resource_uri", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "invalid-uri", "title": "Invalid URI", "updated": "2010-04-03 20:05:00"}]}'
    ...
    def test_patch_list_with_request_data(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"objects": [{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00", "is_active": true, "slug": "cat-again-again", "title": "The Cat Is Back", "updated": "2010-04-03 20:05:00"}]}'

        resp = resource.patch_list(request)
        self.assertEqual(resp.status_code, 202)
        self.assertEqual(resp.content.decode("utf-8"), "")
        self.assertEqual(
            Note.objects.filter(author=request.user, slug="cat-again-again").count(), 1
        )  # Validate that request.user was successfully passed in
    ...
    def test_patch_detail(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"content": "The cat is back. The dog coughed him up out back.", "created": "2010-04-03 20:05:00"}'
        ...
        request._raw_post_data = (
            request._body
        ) = '{"content": "The cat is gone again. I think it was the rabbits that ate him this time."}'
        ...
        request._raw_post_data = (
            request._body
        ) = '{"content": "Wait, now the cat is back."}'
    ...
    def test_dispatch(self):
        ...
        request._raw_post_data = (
            request._body
        ) = '{"title": "Super-duper override ACTIVATE!"}'
        resp = resource.dispatch("detail", request, pk=1)
        self.assertEqual(resp.status_code, 202)
        self.assertEqual(resp.content.decode("utf-8"), "")
        self.assertEqual(
            Note.objects.get(pk=1).title, u"Super-duper override ACTIVATE!"
        )
    ...
    def test_build_bundle(self):
        ...
        req = HttpRequest()
        req.GET = {"foo": "bar"}
        populated_bundle_with_request = resource.build_bundle(
            data={"title": "Foo"}, request=req
        )
    ...
    def test_obj_get_list(self):
        ...
        notes = NoteResource().obj_get_list(
            bundle=base_bundle, title="Recent Volcanic Activity."
        )
        self.assertEqual(len(notes), 1)
    ...
    def test_obj_get(self):
        ...
        self.assertEqual(
            note_obj.content,
            u"This is my very first post using my shiny new API. Pretty sweet, huh?",
        )
        ...
        self.assertEqual(
            list(related_obj.subjects.values_list("id", flat=True)), [1, 2]
        )
    ...
    def test_uri_fields(self):
        ...
        self.assertEqual(
            abs_bundle.data["resource_uri"], "/api/v1/withabsoluteurlnote/1/"
        )
    ...
    def test_jsonp_validation(self):
        ...
        self.assertEqual(resp.status_code, 400)
        self.assertEqual(
            force_str(resp.content), '{"error": "JSONP callback name is invalid."}'
        )
        self.assertEqual(resp["content-type"], "application/json")
    ...
    @patch(
        "tastypie.resources.ModelResource.obj_get_list", side_effect=NotImplementedError
    )
    def test_get_multiple_without_queryset(self, obj_get_list_mock):
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"objects": [{"content": "This is my very first post using my shiny new API. Pretty sweet, huh?", "created": "2010-03-30T20:05:00", "id": 1, "is_active": true, "resource_uri": "/api/v1/notes/1/", "slug": "first-post", "title": "First Post!", "updated": "2010-03-30T20:05:00"}]}',
        )
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"objects": [{"content": "This is my very first post using my shiny new API. Pretty sweet, huh?", "created": "2010-03-30T20:05:00", "id": 1, "is_active": true, "resource_uri": "/api/v1/notes/1/", "slug": "first-post", "title": "First Post!", "updated": "2010-03-30T20:05:00"}, {"content": "The dog ate my cat today. He looks seriously uncomfortable.", "created": "2010-03-31T20:05:00", "id": 2, "is_active": true, "resource_uri": "/api/v1/notes/2/", "slug": "another-post", "title": "Another Post", "updated": "2010-03-31T20:05:00"}]}',
        )
        ...
        self.assertEqual(
            resp.content.decode("utf-8"),
            '{"not_found": ["3"], "objects": [{"content": "The dog ate my cat today. He looks seriously uncomfortable.", "created": "2010-03-31T20:05:00", "id": 2, "is_active": true, "resource_uri": "/api/v1/notes/2/", "slug": "another-post", "title": "Another Post", "updated": "2010-03-31T20:05:00"}]}',
        )
    ...
    def test_check_datetime_throttling(self, mocked_time):
        ...
        retry_after = datetime.datetime(
            year=2014, month=8, day=8, hour=8, minute=55, tzinfo=timezone.utc
        )
    ...
    def test_generate_cache_key(self):
        ...
        self.assertEqual(
            resource.generate_cache_key(foo="bar", moof="baz"),
            "v1:notes::foo=bar:moof=baz",
        )
        self.assertEqual(
            resource.generate_cache_key("abc", "123", foo="bar", moof="baz"),
            "v1:notes:abc:123:foo=bar:moof=baz",
        )
    ...
    def test_configuration(self):
        ...
        self.assertEqual(
            sorted(no_uri.fields.keys()),
            ["content", "created", "id", "is_active", "slug", "title", "updated"],
        )

        with_abs_url = WithAbsoluteURLNoteResource()
        self.assertEqual(len(with_abs_url.fields), 9)
        self.assertEqual(
            sorted(with_abs_url.fields.keys()),
            [
                "absolute_url",
                "content",
                "created",
    ...
    def test_obj_create_full_hydrate_on_create_authorization(self):
        ...
        counter_bundle = cr.build_bundle(
            data={
                "name": "About",
                "slug": "about",
            },
    ...
    def test_obj_update(self):
        ...
        self.assertRaises(
            NotFound, note.obj_update, note_bundle, pk=1, created="2010-03-31T20:05:00"
        )
        self.assertEqual(Note.objects.all().count(), 6)
    ...
    def test_rollback(self):
        ...
        bundles_seen = [
            Bundle(obj=Note.objects.get(pk=1)),
            Bundle(obj=Note()),
            Bundle(),
        ]
        note.rollback(bundles_seen)
            ...
            def clean(self):
                if not self.cleaned_data.get("content", ""):
                    raise forms.ValidationError(
                        "Having no content makes for a very boring note."
                    )
    ...
    def test_self_referential(self):
        ...
        self.assertEqual(
            another_me_baby_me.fields["me_baby_me"].to_class, AnotherSelfResource
        )
    ...
    def test_subclassing(self):
        ...
        self.assertEqual(
            sorted(yetanother.fields.keys()),
            ["abcd", "absolute_url", "mnop", "resource_uri", "title"],
        )
    ...
    def test_per_user_authorization(self):
        ...
        self.assertEqual(
            punr.authorized_read_list(
                punr.get_object_list(empty_request), empty_bundle
            ).count(),
            4,
        )
        ...
        self.assertEqual(
            len(
                json.loads(force_str(punr.get_list(request=empty_request).content))[
                    "objects"
                ]
            ),
            4,
        ...
        self.assertEqual(
            punr.authorized_read_list(
                punr.get_object_list(anony_request), anony_bundle
            ).count(),
            0,
        )
        self.assertEqual(
            len(
                json.loads(force_str(punr.get_list(request=anony_request).content))[
                    "objects"
                ]
            ),
            0,
        ...
        self.assertEqual(
            punr.authorized_read_list(
                punr.get_object_list(authed_request), authed_bundle
            ).count(),
            2,
        )
        self.assertEqual(
            len(
                json.loads(force_str(punr.get_list(request=authed_request).content))[
                    "objects"
                ]
            ),
            2,
        ...
        self.assertEqual(
            punr.authorized_read_list(
                punr.get_object_list(authed_request_2), authed_bundle_2
            ).count(),
            2,
        )
        self.assertEqual(
            len(
                json.loads(force_str(punr.get_list(request=authed_request_2).content))[
                    "objects"
                ]
            ),
            2,
    ...
    def test_per_object_authorization(self):
        ...
        self.assertEqual(
            len(
                ponr.authorized_read_list(
                    ponr.get_object_list(empty_request), empty_bundle
                )
            ),
            2,
        )
        ...
        self.assertEqual(
            len(
                json.loads(force_str(ponr.get_list(request=empty_request).content))[
                    "objects"
                ]
            ),
            2,
    ...
    def regression_test_per_object_detail(self):
        ...
        e = ctx.exception
        self.assertEqual(
            str(e), "More than 'Note' matched 'is_active=True, pk__gte=1'."
        )
        ...
        e = ctx.exception
        self.assertEqual(
            str(e), "Couldn't find an instance of 'Note' which matched 'pk=1000000'."
        )
    ...
    def test_collection_name_patch_list(self):
        ...
        request._body = request._raw_post_data = json.dumps(
            {"alt_objects_delete": [], "alt_objects": [{"title": "Testing"}]}
        )
        request._read_started = False
            ...
            json.dumps(
                {
                    ...
                    "name": "foo",
                    "container_items": [
                        {"parent": resource_uri, "name": "container item 1"}
                    ],
...
class BustedResourceTestCase(TestCase):
    ...
    @override_settings(
        DEBUG=False,
        TASTYPIE_FULL_DEBUG=False,
        TASTYPIE_CANNED_ERROR="Oops, you bwoke it.",
    )
    def test_debug_off_custom_message(self):
        ...
        self.assertEqual(resp.status_code, 500)
        self.assertEqual(
            resp.content.decode("utf-8"), '{"error_message": "Oops, you bwoke it."}'
        )
        self.assertEqual(len(SimpleHandler.logged), 1)
        SimpleHandler.logged = []
    ...
    def test_escaping(self):
        ...
        err_data = json.loads(res.content.decode("utf-8"))
        self.assertTrue(
            "&lt;script&gt;alert(1)&lt;/script&gt;" in err_data["error_message"]
        )
