...
golden_gate_park_query = quote(
    """{"type": "MultiPolygon", "coordinates": [[[[-122.511067, 37.771276], [-122.510037, 37.766391], [-122.510037, 37.763813], [-122.456822, 37.765848], [-122.452960, 37.766459], [-122.454848, 37.773990], [-122.475362, 37.773040], [-122.511067, 37.771276]]]]}"""
)
...
class ViewsTestCase(TestCaseWithFixture):
    def test_gets(self):
        ...
        self.assertEqual(
            deserialized["geonotes"],
            {
                "list_endpoint": "/api/v1/geonotes/",
                "schema": "/api/v1/geonotes/schema/",
            },
        )
        ...
        self.assertEqual(
            [obj["title"] for obj in deserialized["objects"]],
            [
                u"Points inside Golden Gate Park note",
                u"Golden Gate Park",
                u"Line inside Golden Gate Park",
            ],
        )
        ...
        self.assertEqual(
            [obj["title"] for obj in deserialized["objects"]],
            [u"Golden Gate Park", u"Points inside Golden Gate Park note"],
        )
    ...
    def test_posts(self):
        ...
        resp = self.client.post(
            "/api/v1/geonotes/", data=post_data, content_type="application/json"
        )
    ...
    def test_puts(self):
        ...
        resp = self.client.put(
            "/api/v1/geonotes/1/", data=post_data, content_type="application/json"
        )
...
class MoreViewsTestCase(TestCaseWithFixture):
    ...
    def test_get_list(self):
        ...
        self.assertEqual(
            data["objects"][0]["content"], "Wooo two points inside Golden Gate park"
        )
        self.assertEqual(data["objects"][0]["points"]["type"], "MultiPoint")
        self.assertAlmostEqual(
            data["objects"][0]["points"]["coordinates"][0][0], -122.475233, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["points"]["coordinates"][0][1], 37.768616, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["points"]["coordinates"][1][0], -122.470416, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["points"]["coordinates"][1][1], 37.767381, places=5
        )

        self.assertEqual(
            data["objects"][1]["content"],
            "This is a note about Golden Gate Park. It contains Golden Gate Park's polygon",
        )
        ...
        self.assertEqual(
            data["objects"][2]["content"], "A path inside Golden Gate Park! Huzzah!"
        )
        self.assertEqual(data["objects"][2]["lines"]["type"], "MultiLineString")
        self.assertAlmostEqual(
            data["objects"][2]["lines"]["coordinates"][0][0][0], -122.504544, places=5
        )
        self.assertAlmostEqual(
            data["objects"][2]["lines"]["coordinates"][0][0][1], 37.767002, places=5
        )
        self.assertAlmostEqual(
            data["objects"][2]["lines"]["coordinates"][0][1][0], -122.499995, places=5
        )
        self.assertAlmostEqual(
            data["objects"][2]["lines"]["coordinates"][0][1][1], 37.768223, places=5
        )
    ...
    def test_post_object(self):
        ...
        response = self.client.get(
            "/api/v1/geonotes/4/", HTTP_ACCEPT="application/json"
        )
        ...
        self.assertEqual(
            obj["polys"],
            {
                ...
                u"coordinates": [
                    [
                        [
                            [-122.511067, 37.771276],
                            [-122.510037, 37.766390999999999],
                            [-122.510037, 37.763812999999999],
                            [-122.456822, 37.765847999999998],
                            [-122.45296, 37.766458999999998],
                            [-122.454848, 37.773989999999998],
                            [-122.475362, 37.773040000000002],
                            [-122.511067, 37.771276],
                        ]
                    ]
                ],
    ...
    def test_post_xml(self):
        ...
        self.assertEqual(
            ...
            {
                "coordinates": [
                    [-122.475233, 37.768616999999999],
                    [-122.470416, 37.767381999999998],
                ],
                "type": "MultiPoint",
            },
        )
        ...
        self.assertIn(
            '<points type="hash"><coordinates type="list"><objects><value type="float">-122.475233</value><value type="float">37.768617</value></objects><objects><value type="float">-122.470416</value><value type="float">37.767382</value></objects></coordinates><type>MultiPoint</type></points>',
            data,
        )
    ...
    def test_filter_within_on_points(self):
        ...
        # Get points
        response = self.client.get(
            "/api/v1/geonotes/?points__within=%s" % golden_gate_park_query,
            HTTP_ACCEPT="application/json",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_filter_within_on_lines(self):
        ...
        # Get lines
        response = self.client.get(
            "/api/v1/geonotes/?lines__within=%s" % golden_gate_park_query,
            HTTP_ACCEPT="application/json",
        )
        self.assertEqual(response.status_code, 200)
        ...
        self.assertEqual(
            data["objects"][0]["content"], "A path inside Golden Gate Park! Huzzah!"
        )
        self.assertEqual(data["objects"][0]["lines"]["type"], "MultiLineString")
        self.assertAlmostEqual(
            data["objects"][0]["lines"]["coordinates"][0][0][0], -122.504544, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["lines"]["coordinates"][0][0][1], 37.767002, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["lines"]["coordinates"][0][1][0], -122.499995, places=5
        )
        self.assertAlmostEqual(
            data["objects"][0]["lines"]["coordinates"][0][1][1], 37.768223, places=5
        )
    ...
    def test_filter_contains(self):
        ...
        response = self.client.get(
            "/api/v1/geonotes/?polys__contains=%s"
            % quote(points_inside_golden_gate_park),
            HTTP_ACCEPT="application/json",
        )
        self.assertEqual(response.status_code, 200)
